...
"1"),a=g,x.width=a[0],x.height=a[1],x.toDataURL()):null:E?e||"":null===e?null:e}function k(a,b,d,c,e){if(null===a.getAttribute("data-smart-ignore")||c)b=z(a,b,d,e),null!==b&&(a.style.backgroundImage="url("+b+")")}function f(a,b,d,c,e){if(null===a.getAttribute("data-smart-ignore")||c)b=z(a,b,d,e),null!==b&&(a.src=b)}function l(a,b){for(var d,c,e=0;e<document.images.length;e++)d=document.images[e],d.getAttribute("data-match-custom")&&!d.getAttribute("data-match-custom-id")&&(c=Math.random().toString().split(".")[1],
d.setAttribute("data-match-custom-id",c),p[c]=window.matchMedia(d.getAttribute("data-match-custom")),p[c].addListener(function(a){r(a)}(d))),f(d,a,b,!1,!1);v&&!h&&(h=!0,window.addEventListener("scroll",A))}function m(a,b){for(var d,c=document.querySelectorAll("[data-smartImageContainer]"),e=0;e<c.length;e++){d=c[e];if(d.getAttribute("data-match-custom")&&!d.getAttribute("data-match-custom-id")){var f=Math.random().toString().split(".")[1];d.setAttribute("data-match-custom-id",f);p[f]=window.matchMedia(d.getAttribute("data-match-custom"));
p[f].addListener(function(){r(d)})}k(d,a,b,!1,!1)}w&&!h&&(h=!0,window.addEventListener("scroll",A))}function A(){clearTimeout(B);B=setTimeout(function(){var a=document.body.scrollTop,b=a+1.5*window.innerHeight;v&&l(a,b);w&&m(a,b)},100)}var u,y,C=!1,c,B,D=!0,h=!1,v=!1,w=!1,p={};u=window.matchMedia("(-webkit-min-device-pixel-ratio: 1.25),(min-resolution: 120dpi)").matches;window.smartImages=c=window.smartImages||{};c.a=c.a||"(max-width: 650px)";var x=document.createElement("canvas");c.init=function(){var a,
b;C||(C=!0,a=document.body.scrollTop,b=a+1.5*window.innerHeight,l(a,b),document.querySelectorAll&&m(a,b),a=window.matchMedia(c.a),q(a),a.addListener(q),console.log("Images are smart, now."))};c.noAutoInit=function(){D=!1};c.manualAssign=function(a){a instanceof Image?f(a,0,0,!0,!1):k(a,0,0,!0,!1)};c.getSrc=function(a){return f(a,0,0,!0,!0)};c.getBackground=function(a){return k(a,0,0,!0,!0)};window.addEventListener("load",function(){!0===D&&c.init()})})();