...
a[0],w.height=a[1],w.toDataURL()):null:D?f||"":null===f?null:f}function m(a,b,e,d,f){if(null===a.getAttribute("data-smart-ignore")||d)b=y(a,b,e,f),null!==b&&(a.style.backgroundImage=b)}function g(a,b,e,d,f){if(null===a.getAttribute("data-smart-ignore")||d)b=y(a,b,e,f),null!==b&&(a.src=b)}function n(a,b){for(var e,d,f=0;f<document.images.length;f++)e=document.images[f],e.getAttribute("data-match-custom")&&!e.getAttribute("data-match-custom-id")&&(d=Math.random().toString().split(".")[1],e.setAttribute("data-match-custom-id",
d),r[d]=window.matchMedia(e.getAttribute("data-match-custom")),r[d].addListener(function(){u(e)})),g(e,a,b,!1,!1);z&&!k&&(k=!0,window.addEventListener("scroll",function(){clearTimeout(l);l=setTimeout(n,100)}))}function p(a,b){for(var e,d=document.querySelectorAll("[data-smartImageContainer]"),f=0;f<d.length;f++){e=d[f];if(e.getAttribute("data-match-custom")&&!e.getAttribute("data-match-custom-id")){var g=Math.random().toString().split(".")[1];e.setAttribute("data-match-custom-id",g);r[g]=window.matchMedia(e.getAttribute("data-match-custom"));
r[g].addListener(function(){u(e)})}m(e,a,b,!1,!1)}A&&!k&&(k=!0,window.addEventListener("scroll",function(){clearTimeout(l);l=setTimeout(p,100)}))}var v,x,B=!1,d,l,C=!0,k=!1,z=!1,A=!1,r={};v=window.matchMedia("(-webkit-min-device-pixel-ratio: 1.25),(min-resolution: 120dpi)").matches;d=window.c=window.c||{};d.a=d.a||"(max-width: 650px)";var w=document.createElement("canvas");d.b=function(){var a,b;B||(B=!0,a=document.body.scrollTop,b=a+1.5*window.innerHeight,n(a,b),document.querySelectorAll&&p(a,b),
a=window.matchMedia(d.a),t(a),a.addListener(t),console.log("Images are smart, now."))};d.i=function(){C=!1};d.h=function(a){a instanceof Image?g(a,0,0,!0,!1):m(a,0,0,!0,!1)};d.g=function(a){return g(a,0,0,!0,!0)};d.f=function(a){return m(a,0,0,!0,!0)};window.addEventListener("load",function(){!0===C&&d.b()})})();